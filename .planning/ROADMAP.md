...
Plans:
- [ ] 04-01-PLAN.md — GPX parser + Douglas-Peucker downsampler (<=200 cap) + Strava route Gson models & URL builders (pure seams, Wave 0 tests)
- [ ] 04-02-PLAN.md — OsrmClient via-point routing (waypoints=0;{last}) + non-final-arrive filter + follow-route synthetic step (pure seams + getRouteVia)
...
| 4. Strava Route Import + Navigation | 0/6 | Planned | - |
