...
Plans:
- [ ] 02-01-PLAN.md — Glasses test infra (Wave 0) + pure sport-state core: SPORT enum, staleness ladder, 3-way tap cycle, SportFormat — first glasses JVM tests
- [ ] 02-02-PLAN.md — sport_state consumption (no-op → applySportState) + layout-mode ownership fix so taps survive the 1Hz stream
...
| 2. Glasses Sport HUD | 0/4 | Planned | - |
