...
Plans:
- [ ] 03-01-PLAN.md — Pure OAuth core (Wave 1): authorize URL + CSRF state, Gson token/athlete models, 30-min expiry math, single-flight refresh coordinator — first strava JVM tests (Wave 0 closed)
...
| 3. Strava Authentication | 0/4 | Planned | - |
